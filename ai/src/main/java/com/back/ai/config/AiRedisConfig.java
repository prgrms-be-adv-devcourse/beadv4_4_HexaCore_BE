...
public class AiRedisConfig {
    ...
    public CacheManager aiCacheManager(RedisConnectionFactory redisConnectionFactory) {
        ...
        redisCacheConfigurations.put(AiCacheNames.EMBEDDING, defaultCacheConfig.entryTtl(Duration.ofDays(7))); // AI 임베딩 7일
    ...
    private JsonMapper createJsonMapper() {
        ...
        AiRecordSupportingTypeResolver typer = new AiRecordSupportingTypeResolver(typeValidator, DefaultTyping.NON_FINAL);
