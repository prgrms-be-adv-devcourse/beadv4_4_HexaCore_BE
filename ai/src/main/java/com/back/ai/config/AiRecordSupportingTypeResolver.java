...
public class AiRecordSupportingTypeResolver extends DefaultTypeResolverBuilder {

    public AiRecordSupportingTypeResolver(PolymorphicTypeValidator typeValidator, DefaultTyping t) {
